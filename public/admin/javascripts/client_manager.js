$("#client_maneger_page").addClass("select_li")
$("#client_maneger_page img").attr("src", 'images/admin_light.png')
...
var get_all_user = function () {
    $.post('all_users', {user_id: $.cookie(USER_ID_COOKIE), type: "CLIENT B"}, function (response) {
